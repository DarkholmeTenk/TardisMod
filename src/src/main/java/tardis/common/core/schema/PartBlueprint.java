...
public class PartBlueprint
{
	...
	public PartBlueprint(World world, String name, int x, int y, int z) throws SchemaDoorNotFoundException, SchemaCoreNotFoundException
	{
		myName = name;
	...
	private CoordStore rotate(CoordStore key,int cFace,int dFace)
	{
		if(cFace == dFace)
			return key;
