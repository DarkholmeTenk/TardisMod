...
public class AbstractPacket extends FMLProxyPacket
{
	...
	public AbstractPacket(ByteBuf payload, String channel)
	{
		super(payload, channel);
		buffer = payload;
	}
	
	public AbstractPacket(ByteBuf payload, NBTTagCompound nbt, byte discriminator)
	{
	...
	public AbstractPacket(ByteBuf payload)
	{
		super(payload,"tardis");
		buffer = payload;
	}
