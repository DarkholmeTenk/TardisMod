...
@Mod(modid = "TardisMod", name = "Tardis Mod", version = "0.9825", dependencies = "required-after:FML; required-after:darkcore@[0.22,]; after:CoFHCore; after:appliedenergistics2; after:Waila")
