...
import tardis.core.console.control.ControlPush;
...
import tardis.core.console.control.models.ModelToggleSwitch;
...
public class NormalPanelY extends ConsolePanel implements NavPanelY, OptPanelLandOnGround, OptPanelLandOnPad, NavPanelDims
{
	...
	private final ControlToggleButton landOnPad = addControl(new ControlToggleButtonBuilder(true)
			.withModel(new ModelToggleSwitch())
			.isFlightControl()
			.withScale(0.25, 0.25, 0.25)
	...
	private final ControlPush generate = addControl(new ControlPushBuilder(()->holder.generateScrewdriver())
			.withScale(0.25,0.25,0.25)
